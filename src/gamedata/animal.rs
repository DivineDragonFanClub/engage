...
impl AnimalData {
    ...
    pub fn increment_amount_capture(&self, amount: i32) { unsafe { inc_animal_capture_num(self, amount, None); }}
    pub fn increment_capture(&self) { unsafe { inc_animal_capture_num(self, 1, None); }}
    pub fn get_animal_by_pid(pid: &Il2CppString) -> Option<&AnimalData> { unsafe { get_animal_by_PID(pid, None) } }
}
